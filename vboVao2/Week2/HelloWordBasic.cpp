...
void initGL() {
    ...
    const GLchar* vertexShaderSource[] = {
        "#version 330\n in vec2 LVertexPos2D; void main() { gl_Position = vec4(LVertexPos2D.x,LVertexPos2D.y,0.0f,1.0f); }"
    };
    ...
    {
        "#version 330\n out vec4 LFragment; void main(){ LFragment = vec4( 1.0f,1.0f,1.0f,1.0f); }"
    };
